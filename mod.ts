...
import { bot, Intents, startBot } from "./deps.ts";
...
await fileLoader();
if (!bot.eventHandlers.debug) throw "No events loaded";
...
if (!bot.commands.size) throw "No commands loaded";
if (!bot.arguments.size) throw "No args loaded";
